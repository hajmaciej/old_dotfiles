...
exec --no-startup-id /home/${USER}/.config/i3/scripts/mime.sh vivaldiStableI3
#exec --no-startup-id /usr/bin/vivaldi-stable --user-data-dir="/home/fm/.config/vivaldi/i3" 
